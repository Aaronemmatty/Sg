...
const BACKEND_PATH_MAP: Record<string, string> = {
  ...
  "risk/kill-switch/activate": "/risk/kill-switch/activate",
  "risk/kill-switch/deactivate": "/risk/kill-switch/deactivate",
  "risk/kill-switch/reset": "/risk/kill-switch/reset",
  "risk/emergency-stop": "/risk/emergency-stop",
